...
def parse_args():
    ...
    parser.add_argument("--unfreeze_layers", type=int, default=None, help="Num layers to unfreeze.")
...
def main():
    ...
    for fold, (train_ids, val_ids) in enumerate(kfold.split(full_dataset, stratify_labels_np)):
        ...
        result = trainer.fit(train_loader=train_loader, val_loader=val_loader, epochs=args.epochs, tokenizer=tokenizer)
